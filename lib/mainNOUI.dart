...
class _MyHomePageState extends State<MyHomePage> {
  ...
  initialiseDimensions() {
    ...
    dbObj = DBService(dialogHeight: dialogHeight, dialogWidth: dialogWidth, style: style);
    setState(() {
      dimensionsSet = true;
    });
  }
  ...
  buildSearchWidget(BuildContext ctx) =>
      Navigator.push(ctx, MaterialPageRoute(builder: (ctx) => SearchScreen(w: dialogWidth, h: dialogHeight, style: style)));
              ...
              children: [
                ...
                FlatButton(
                  onPressed: () {
                    ...
                    dbObj.addUser(userObj: user, context: context);
                  },
                  child: Text('ADD USER'),
                ),
              ],
                ...
                Row(
                  ...
                  children: [
                    ...
                    FlatButton(
                      ...
                      color: Colors.white60,
                      onPressed: () {
                        dbObj.deleteUser(context: context, docId: docID);
                        Navigator.pop(context);
                      },
                      child: Text('YES'),
                    ),
                    ...
                    FlatButton(
                        ...
                        onPressed: () {
                          ...
                          if (user.name != null && user.email != null && user.phone != null)
                            dbObj.updateDetails(
                                nm: user.name, eml: user.email, phoneNo: user.phone, dID: docID, context: context);
                          else
                            showDialog(
                              context: context,
                              child: Dialog(
